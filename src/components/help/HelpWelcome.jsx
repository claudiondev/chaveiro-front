...
export default function HelpWelcome({ onStart, onDismiss }) {
  return <div className="fixed inset-0 z-[85] flex items-center justify-center bg-black/70 p-5">
    <section role="dialog" aria-modal="true" aria-labelledby="welcome-help-title" className="w-full max-w-md rounded-3xl border border-marinho-borda bg-marinho-claro p-6 shadow-flutuante sm:p-8">
